...
if ~exist('INITIALIZE_ROUTES_M', 'var')
    ...
    ROUTE_CHICAGO_TO_PITTSBURG_A = Route(CHICAGO, PITTSBURG, ORANGE, 3);
    ROUTE_CHICAGO_TO_PITTSBURG_B = Route(CHICAGO, PITTSBURG, BLACK, 3);
    ...
    ROUTE_DULUTH_TO_HELENA = Route(DULUTH, HELENA, ORANGE, 5);
    ...
    ROUTE_NASHVILLE_TO_PITTSBURG = Route(NASHVILLE, PITTSBURG, YELLOW, 4);
    ...
    ROUTE_NEW_YORK_TO_PITTSBURG_A = Route(NEW_YORK, PITTSBURG, WHITE, 2);
    ROUTE_NEW_YORK_TO_PITTSBURG_B = Route(NEW_YORK, PITTSBURG, WHITE, 2);
    ...
    ROUTE_PITTSBURG_TO_RALEIGH = Route(PITTSBURG, RALEIGH, GRAY, 2);
    ROUTE_PITTSBURG_TO_SAINT_LOUIS = Route(PITTSBURG, SAINT_LOUIS, GREEN, 5);
    ROUTE_PITTSBURG_TO_TORONTO = Route(PITTSBURG, TORONTO, GRAY, 2);
    ROUTE_PITTSBURG_TO_WASHINGTON_DC = Route(PITTSBURG, WASHINGTON_DC, GRAY, 2);
