...
if ~exist('INITIALIZE_ROUTES_M', 'var')
    ...
    ATLANTA_TO_CHARLESTON = Route(ATLANTA, CHARLESTON, GRAY, 2);
    ATLANTA_TO_MIAMI = Route(ATLANTA, MIAMI, BLUE, 5);
    ATLANTA_TO_NASHVILLE = Route(ATLANTA, NASHVILLE, GRAY, 1);
    ATLANTA_TO_NEW_ORLEANS_A = Route(ATLANTA, NEW_ORLEANS, ORANGE, 4);
    ATLANTA_TO_NEW_ORLEANS_B = Route(ATLANTA, NEW_ORLEANS, YELLOW, 4);
    ATLANTA_TO_RALEIGH_A = Route(ATLANTA, RALEIGH, GRAY, 2);
    ATLANTA_TO_RALEIGH_B = Route(ATLANTA, RALEIGH, GRAY, 2);

    BOSTON_TO_MONTREAL_A = Route(BOSTON, MONTREAL, GRAY, 2);
    BOSTON_TO_MONTREAL_B = Route(BOSTON, MONTREAL, GRAY, 2);
    BOSTON_TO_NEW_YORK_A = Route(BOSTON, NEW_YORK, YELLOW, 2);
    BOSTON_TO_NEW_YORK_B = Route(BOSTON, NEW_YORK, RED, 2);

    CALGARY_TO_HELENA = Route(CALGARY, HELENA, GRAY, 4);
    CALGARY_TO_SEATTLE = Route(CALGARY, SEATTLE, GRAY, 4);
    CALGARY_TO_VANCOUVER = Route(CALGARY, VANCOUVER, GRAY, 3);
    CALGARY_TO_WINNIPEG = Route(CALGARY, WINNIPEG, WHITE, 6);

    CHARLESTON_TO_MIAMI = Route(CHARLESTON, MIAMI, PURPLE, 4);
    CHARLESTON_TO_RALEIGH = Route(CHARLESTON, RALEIGH, GRAY, 2);
    ...
    DALLAS_TO_HOUSTON_A = Route(DALLAS, HOUSTON, GRAY, 1);
    DALLAS_TO_HOUSTON_B = Route(DALLAS, HOUSTON, GRAY, 1);
    DALLAS_TO_LITTLE_ROCK = Route(DALLAS, LITTLE_ROCK, GRAY, 2);
    DALLAS_TO_OKLAHOMA_CITY_A = Route(DALLAS, OKLAHOMA_CITY, GRAY, 2);
    DALLAS_TO_OKLAHOMA_CITY_B = Route(DALLAS, OKLAHOMA_CITY, GRAY, 2);
    ...
    DENVER_TO_SANTA_FE = Route(DENVER, SANTA_FE, GRAY, 2);

    DULUTH_TO_HELENA = Route(DULUTH, HELENA, ORANGE, 5);
    DULUTH_TO_OMAHA_A = Route(DULUTH, OMAHA, GRAY, 2);
    DULUTH_TO_OMAHA_B = Route(DULUTH, OMAHA, GRAY, 2);
    DULUTH_TO_SAULT_ST_MARIE = Route(DULUTH, SAULT_ST_MARIE, GRAY, 3);
    DULUTH_TO_TORONTO = Route(DULUTH, TORONTO, PURPLE, 6);
    DULUTH_TO_WINNIPEG = Route(DULUTH, WINNIPEG, GRAY, 6);
    ...
    EL_PASO_TO_PHOENIX = Route(EL_PASO, PHOENIX, GRAY, 3);
    EL_PASO_TO_SANTA_FE = Route(EL_PASO, SANTA_FE, GRAY, 2);
    ...
    HOUSTON_TO_NEW_ORLEANS = Route(HOUSTON, NEW_ORLEANS, GRAY, 2);

    KANSAS_CITY_TO_OKLAHOMA_CITY_A = Route(KANSAS_CITY, OKLAHOMA_CITY, GRAY, 2);
    KANSAS_CITY_TO_OKLAHOMA_CITY_B = Route(KANSAS_CITY, OKLAHOMA_CITY, GRAY, 2);
    KANSAS_CITY_TO_OMAHA_A = Route(KANSAS_CITY, OMAHA, GRAY, 1);
    KANSAS_CITY_TO_OMAHA_B = Route(KANSAS_CITY, OMAHA, GRAY, 1);
    ...
    LAS_VEGAS_TO_LOS_ANGELES = Route(LAS_VEGAS, LOS_ANGELES, GRAY, 2);
    LAS_VEGAS_TO_SALT_LAKE_CITY = Route(LAS_VEGAS, SALT_LAKE_CITY, ORANGE, 3);

    LOS_ANGELES_TO_PHOENIX = Route(LOS_ANGELES, PHOENIX, GRAY, 3);
    ...
    LITTLE_ROCK_TO_OKLAHOMA_CITY = Route(LITTLE_ROCK, OKLAHOMA_CITY, GRAY, 2);
    LITTLE_ROCK_TO_SAINT_LOUIS = Route(LITTLE_ROCK, SAINT_LOUIS, GRAY, 2);
    ...
    PHOENIX_TO_SANTA_FE = Route(PHOENIX, SANTA_FE, GRAY, 3);

    PITTSBURG_TO_RALEIGH = Route(PITTSBURG, RALEIGH, GRAY, 2);
    PITTSBURG_TO_SAINT_LOUIS = Route(PITTSBURG, SAINT_LOUIS, GREEN, 5);
    PITTSBURG_TO_TORONTO = Route(PITTSBURG, TORONTO, GRAY, 2);
    PITTSBURG_TO_WASHINGTON_DC = Route(PITTSBURG, WASHINGTON_DC, GRAY, 2);
    ...
    PORTLAND_TO_SEATTLE_A = Route(PORTLAND, SEATTLE, GRAY, 1);
    PORTLAND_TO_SEATTLE_B = Route(PORTLAND, SEATTLE, GRAY, 1);
    
    RALEIGH_TO_WASHINGTON_DC_A = Route(RALEIGH, WASHINGTON_DC, GRAY, 2);
    RALEIGH_TO_WASHINGTON_DC_B = Route(RALEIGH, WASHINGTON_DC, GRAY, 2);
    ...
    SAULT_ST_MARIE_TO_TORONTO = Route(SAULT_ST_MARIE, TORONTO, GRAY, 2);
    SAULT_ST_MARIE_TO_WINNIPEG = Route(SAULT_ST_MARIE, WINNIPEG, GRAY, 6);

    SEATTLE_TO_VANCOUVER_A = Route(SEATTLE, VANCOUVER, GRAY, 1);
    SEATTLE_TO_VANCOUVER_B = Route(SEATTLE, VANCOUVER, GRAY, 1);
